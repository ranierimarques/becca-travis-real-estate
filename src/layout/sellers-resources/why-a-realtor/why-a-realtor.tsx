    ...
    <S.Section>
      <S.Container>
        <S.Content>
          ...
          <S.Paragraph>
            While it is possible to sell a home without the help of a realtor,
            there are several reasons why working with an experienced
            professional can be advantageous. Here are three of the most
            important ones:
          </S.Paragraph>
          ...
          {reasons.map(reason => {
            return (
              <S.Reasons key={reason.title}>
                <Box css={{ position: "absolute", top: -24, left: 32 }}>
                  {reason.svg}
                </Box>
                <S.Svg />
