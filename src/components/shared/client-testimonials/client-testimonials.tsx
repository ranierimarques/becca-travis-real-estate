  ...
  },
  {
    ...
    text: (
      <>
        ...
        <S.ReviewSpan>
          You will be treated with the same courtesy, respect and professionalism when you
          put the search of your future home or next investment in the hands of Becca
          Travis.
        </S.ReviewSpan>
        <S.ReviewSpan>How do I know this?</S.ReviewSpan>
        <S.ReviewSpan>Because I am now one happy home owner.</S.ReviewSpan>
        <S.ReviewSpan>
          Frankly speaking, most reviews about anything these days are either paid for or
          fakes.
        </S.ReviewSpan>
        <S.ReviewSpan>
        ...
        <S.ReviewSpan>
          ...
          keyboard when asked to write this review - it’s looking more like an article now
          actually.
        </S.ReviewSpan>
        <S.ReviewSpan>
        ...
        <S.ReviewSpan>
          Becca puts her client first, and with patience and some love will review as many
          houses as needed to make sure you are buying exactly what makes you happy and
          within your budget.
        </S.ReviewSpan>
        <S.ReviewSpan>
          And she’ll guide you through the process with expert advice and recommendations.
        </S.ReviewSpan>
        <S.ReviewSpan>
        ...
        <S.ReviewSpan>
          That’s right! Some agents for example are not interest in clients with purchases
          under $300000.00
        </S.ReviewSpan>
...
export function ClientTestimonials() {
  ...
  return (
    <section>
      <S.Wrapper>
        <Hat css={{ mb: 8, '@bp4': { mb: 12 } }}>CUSTOMERS STORIES</Hat>
        ...
        <S.ViewAllLink href="/reviews">
          View all stories <Svg.Arrow />
        </S.ViewAllLink>
      </S.Wrapper>
      ...
      <S.TestimonialsContainer ref={testimonialsContainerRef} resize={resize}>
        <S.TestimonialsList>
          {reviews.map(review => (
            <Testimonial key={review.name} review={review} resize={resize} />
          ))}
        </S.TestimonialsList>
